...
struct StarshipOverloadView: View {
    @StateObject var viewModel =  StarshipOverloadViewModel()
    ...
    var body: some View {
        ZStack {
            ...
            ZStack {
                Image(viewModel.gameResult == .lose ? "loserocker" : "rocket")
                    .resizable()
                ...
                if viewModel.showResult {
                    if viewModel.gameResult == .win {
                        Rectangle()
                            .fill(LinearGradient(colors: [Color(red: 195/255, green: 27/255, blue: 200/255),
                                                          Color(red: 127/255, green: 3/255, blue: 130/255)], startPoint: .top, endPoint: .bottom))
                            .overlay {
                    ...
                    ZStack {
                        Rectangle()
                            ...
                            .overlay {
                                VStack {
                                    Text("\(viewModel.bet)")
                                        .foregroundStyle(LinearGradient(colors: [Color(red: 195/255, green: 27/255, blue: 200/255),
                                                                                 Color(red: 127/255, green: 3/255, blue: 130/255)], startPoint: .top, endPoint: .bottom))
