...
class MythicalZooViewModel: ObservableObject {
    let contact = MythicalZooModel()
    @Published var coin = UserDefaultsManager.shared.coins
    @Published var bet: Int = 50
    @Published var slots: [[String]] = []
    let allFruits = ["z1", "z2", "z3","z4", "z5", "z6"]
    ...
    let symbolArray = [
        Symbol(image: "z1", value: "1000"),
        Symbol(image: "z2", value: "500"),
        Symbol(image: "z3", value: "100"),
        Symbol(image: "z4", value: "50"),
        Symbol(image: "z5", value: "10"),
        Symbol(image: "z6", value: "5")
    ]
