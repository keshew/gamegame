...
struct PirateQueensFortuneView: View {
    @StateObject var viewModel =  PirateQueensFortuneViewModel()
            ...
            VStack(spacing: 50) {
                HStack(spacing: 15) {
                    Button(action: {
                        ...
                        Circle()
                            .fill(LinearGradient(colors: [Color(red: 240/255, green: 159/255, blue: 29/255),
                                                          Color(red: 145/255, green: 61/255, blue: 11/255)], startPoint: .top, endPoint: .bottom))
                            .overlay {
                                Image("backImg2")
                                    .resizable()
