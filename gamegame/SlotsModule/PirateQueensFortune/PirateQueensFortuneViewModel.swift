...
class PirateQueensFortuneViewModel: ObservableObject {
    let contact = PirateQueensFortuneModel()
    @Published var coin = UserDefaultsManager.shared.coins
    @Published var bet: Int = 50
    @Published var win = 0
    @Published var slots: [[String]] = []
    let allFruits = ["pir1", "pir2", "pir3","pir4", "pir5", "pir6"]
    ...
    let symbolArray = [
        Symbol(image: "pir1", value: "1000"),
        Symbol(image: "pir2", value: "500"),
        Symbol(image: "pir3", value: "100"),
        Symbol(image: "pir4", value: "50"),
        Symbol(image: "pir5", value: "10"),
        Symbol(image: "pir6", value: "5")
    ]
